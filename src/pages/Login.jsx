  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 w-full h-64 lg:h-auto relative">
        <img
          src="https://images.pexels.com/photos/26923471/pexels-photo-26923471.jpeg"
          alt="LankaStay Banner"
        ...
        <div className="absolute inset-0  bg-opacity-40 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-lg lg:text-xl">Sign in to continue your journey with LankaStay</p>
          </div>
        </div>
      </div>

      {/* Right Section - Login Form */}
      <div className="lg:w-1/2 w-full flex items-center justify-center bg-gray-50 p-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Sign In</h2>
            <p className="text-gray-600">Access your LankaStay account</p>
          </div>
