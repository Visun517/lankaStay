...
public class BusinessController {
    ...
    public ResponseEntity<ApiResponseDto> getProfile(Authentication authentication) {
        ...
        return ResponseEntity.ok(
                new ApiResponseDto(
                        ...
                        businessService.getProfile(user.getId())
                )
        );
    }
    ...
    public ResponseEntity<ApiResponseDto> getNearByBusinesses(
    ...
    @GetMapping("/getBusiness/{type}")
    public ResponseEntity<ApiResponseDto> getNearByBusinessesByHotel(
        ...
        return ResponseEntity.ok(
                new ApiResponseDto(
                        200,
                        "Near by businesses fetched successfully",
                        businessService.getNearByBusinessesByType(type , userLocation, radius, user.getId())
                )
        );
    }
